#!/usr/bin/env python3
"""
Linux Privilege Escalation - Utility Script

Uso:
    python linux_privilege_escalation.py --analyze <input>
    python linux_privilege_escalation.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Linux Privilege Escalation")
