#!/usr/bin/env python3
"""
Dotnet Backend Patterns - Utility Script

Uso:
    python dotnet_backend_patterns.py --analyze <input>
    python dotnet_backend_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Dotnet Backend Patterns")
