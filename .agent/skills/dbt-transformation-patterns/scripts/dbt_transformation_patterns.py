#!/usr/bin/env python3
"""
Dbt Transformation Patterns - Utility Script

Uso:
    python dbt_transformation_patterns.py --analyze <input>
    python dbt_transformation_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Dbt Transformation Patterns")
