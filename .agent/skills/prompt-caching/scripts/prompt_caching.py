#!/usr/bin/env python3
"""
Prompt Caching - Utility Script

Uso:
    python prompt_caching.py --analyze <input>
    python prompt_caching.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Prompt Caching")
