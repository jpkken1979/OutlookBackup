#!/usr/bin/env python3
"""
Attack Tree Construction - Utility Script

Uso:
    python attack_tree_construction.py --analyze <input>
    python attack_tree_construction.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Attack Tree Construction")
