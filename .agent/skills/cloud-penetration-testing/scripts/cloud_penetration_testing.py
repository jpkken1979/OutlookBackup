#!/usr/bin/env python3
"""
Cloud Penetration Testing - Testing Utilities

Uso:
    python cloud_penetration_testing.py --file src/module.py
    python cloud_penetration_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Cloud Penetration Testing")
