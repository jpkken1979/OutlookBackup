#!/usr/bin/env python3
"""
Data Scientist - DevOps Utilities

Uso:
    python data_scientist.py --check-docker
    python data_scientist.py --check-ci
    python data_scientist.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Data Scientist")
