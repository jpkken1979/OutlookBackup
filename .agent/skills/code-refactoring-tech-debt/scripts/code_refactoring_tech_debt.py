#!/usr/bin/env python3
"""
Code Refactoring Tech Debt - Utility Script

Uso:
    python code_refactoring_tech_debt.py --analyze <input>
    python code_refactoring_tech_debt.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Code Refactoring Tech Debt")
