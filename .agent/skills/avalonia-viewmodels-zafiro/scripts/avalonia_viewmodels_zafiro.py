#!/usr/bin/env python3
"""
Avalonia Viewmodels Zafiro - Utility Script

Uso:
    python avalonia_viewmodels_zafiro.py --analyze <input>
    python avalonia_viewmodels_zafiro.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Avalonia Viewmodels Zafiro")
