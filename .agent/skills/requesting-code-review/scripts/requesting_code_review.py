#!/usr/bin/env python3
"""
Requesting Code Review - Utility Script

Uso:
    python requesting_code_review.py --analyze <input>
    python requesting_code_review.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Requesting Code Review")
