#!/usr/bin/env python3
"""
Email Sequence - Utility Script

Uso:
    python email_sequence.py --analyze <input>
    python email_sequence.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Email Sequence")
