#!/usr/bin/env python3
"""
Backend Security Coder - Security Scanner

Uso:
    python backend_security_coder.py --file src/app.py
    python backend_security_coder.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Backend Security Coder")
