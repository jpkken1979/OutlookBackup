#!/usr/bin/env python3
"""
Concise Planning - DevOps Utilities

Uso:
    python concise_planning.py --check-docker
    python concise_planning.py --check-ci
    python concise_planning.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Concise Planning")
