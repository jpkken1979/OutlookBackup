#!/usr/bin/env python3
"""
React Patterns - Frontend Analyzer

Uso:
    python react_patterns.py --check-a11y src/
    python react_patterns.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="React Patterns")
