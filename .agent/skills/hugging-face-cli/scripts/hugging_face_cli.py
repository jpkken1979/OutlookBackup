#!/usr/bin/env python3
"""
Hugging Face Cli - Utility Script

Uso:
    python hugging_face_cli.py --analyze <input>
    python hugging_face_cli.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Hugging Face Cli")
