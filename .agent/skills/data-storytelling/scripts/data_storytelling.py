#!/usr/bin/env python3
"""
Data Storytelling - Utility Script

Uso:
    python data_storytelling.py --analyze <input>
    python data_storytelling.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Data Storytelling")
