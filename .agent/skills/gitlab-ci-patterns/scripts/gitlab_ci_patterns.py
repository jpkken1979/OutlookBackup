#!/usr/bin/env python3
"""
Gitlab Ci Patterns - DevOps Utilities

Uso:
    python gitlab_ci_patterns.py --check-docker
    python gitlab_ci_patterns.py --check-ci
    python gitlab_ci_patterns.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Gitlab Ci Patterns")
