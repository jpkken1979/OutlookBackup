#!/usr/bin/env python3
"""
Search Specialist - DevOps Utilities

Uso:
    python search_specialist.py --check-docker
    python search_specialist.py --check-ci
    python search_specialist.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Search Specialist")
