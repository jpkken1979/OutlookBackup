#!/usr/bin/env python3
"""
Distributed Tracing - DevOps Utilities

Uso:
    python distributed_tracing.py --check-docker
    python distributed_tracing.py --check-ci
    python distributed_tracing.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Distributed Tracing")
