#!/usr/bin/env python3
"""
Ui Skills - Frontend Analyzer

Uso:
    python ui_skills.py --check-a11y src/
    python ui_skills.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ui Skills")
