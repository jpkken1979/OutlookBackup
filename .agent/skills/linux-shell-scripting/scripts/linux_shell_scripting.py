#!/usr/bin/env python3
"""
Linux Shell Scripting - Utility Script

Uso:
    python linux_shell_scripting.py --analyze <input>
    python linux_shell_scripting.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Linux Shell Scripting")
