#!/usr/bin/env python3
"""
Machine Learning Ops Ml Pipeline - DevOps Utilities

Uso:
    python machine_learning_ops_ml_pipeline.py --check-docker
    python machine_learning_ops_ml_pipeline.py --check-ci
    python machine_learning_ops_ml_pipeline.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Machine Learning Ops Ml Pipeline")
