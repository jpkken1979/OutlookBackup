#!/usr/bin/env python3
"""
Debugging Strategies - Utility Script

Uso:
    python debugging_strategies.py --analyze <input>
    python debugging_strategies.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Debugging Strategies")
