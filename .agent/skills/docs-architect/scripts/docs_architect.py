#!/usr/bin/env python3
"""
Docs Architect - Documentation Generator

Uso:
    python docs_architect.py --file src/module.py --output docs/
    python docs_architect.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Docs Architect")
