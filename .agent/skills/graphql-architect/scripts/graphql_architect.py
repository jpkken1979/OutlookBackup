#!/usr/bin/env python3
"""
Graphql Architect - Utility Script

Uso:
    python graphql_architect.py --analyze <input>
    python graphql_architect.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Graphql Architect")
