#!/usr/bin/env python3
"""
Postmortem Writing - Utility Script

Uso:
    python postmortem_writing.py --analyze <input>
    python postmortem_writing.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Postmortem Writing")
