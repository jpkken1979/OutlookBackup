#!/usr/bin/env python3
"""
React Ui Patterns - Frontend Analyzer

Uso:
    python react_ui_patterns.py --check-a11y src/
    python react_ui_patterns.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="React Ui Patterns")
