#!/usr/bin/env python3
"""
Sql Pro - Database Utilities

Uso:
    python sql_pro.py --analyze schema.sql
    python sql_pro.py --check-models models.py
"""
...
def main():
    parser = argparse.ArgumentParser(description="Sql Pro")
