#!/usr/bin/env python3
"""
Context Fundamentals - Utility Script

Uso:
    python context_fundamentals.py --analyze <input>
    python context_fundamentals.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Fundamentals")
