#!/usr/bin/env python3
"""
Busybox On Windows - Utility Script

Uso:
    python busybox_on_windows.py --analyze <input>
    python busybox_on_windows.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Busybox On Windows")
