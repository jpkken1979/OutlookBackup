...
description: >-
---
  Use when creating, updating, or improving agent skills. Triggers: new skill,
  create skill, update skill, skill documentation, skill template, God Mode
  skill, skill architecture.
metadata:
  category: meta
  author: ozy
  triggers: skill-md pattern, triggers, axioms, security checklist, few-shot examples, skill-builder
...
## 🏆 The "God Mode" Template (2026 Standard)

Every high-performance skill MUST follow this structure to ensure the AI actually triggers and executes it correctly:

### 1. The Triggered Frontmatter
```yaml
---
name: skill-folder-name
description: Use when [Symptom/Intent]. Triggers: [Keyword1, Keyword2, LibraryName].
metadata:
  triggers: keyword1, keyword2, library
---
```

### 2. Axioms (Core Principles)
3-5 "Laws" that the agent cannot break.

### 3. Step-by-Step Implementation
The exact "Algorithm" the agent should follow.

### 4. Security & Quality Checklist
Mandatory checks before the agent considers the task "Done".

### 5. Few-shot Examples
Real-world code snippets showing the successful application of the skill.

## Examples (God Mode):
[See frontend-design-galaxy/SKILL.md for a live implementation](file:///c:/Users/Kenji/Documents/GitHub/OpenAntigravity26.3.30/.agent/skills/frontend-design-galaxy/SKILL.md)
