#!/usr/bin/env python3
"""
Writing Skills - Utility Script

Uso:
    python writing_skills.py --analyze <input>
    python writing_skills.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Writing Skills")
