#!/usr/bin/env python3
"""
Security Scanning Security Sast - Security Scanner

Uso:
    python security_scanning_security_sast.py --file src/app.py
    python security_scanning_security_sast.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Security Scanning Security Sast")
