...
|-------|---|---|
| `security-dependencies-scan` | Complementary — analyzes dependencies instead of code | Audit third-party libraries for CVEs and compliance |
| `cc-skill-security-review` | Complementary — developer checklist | Manual pre-deployment security review |
| `security-hardening-scan` | Orchestrator — coordinates full hardening program | Complete security initiative |
