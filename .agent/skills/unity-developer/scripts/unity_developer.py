#!/usr/bin/env python3
"""
Unity Developer - Testing Utilities

Uso:
    python unity_developer.py --file src/module.py
    python unity_developer.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Unity Developer")
