#!/usr/bin/env python3
"""
Python Testing Patterns - Testing Utilities

Uso:
    python python_testing_patterns.py --file src/module.py
    python python_testing_patterns.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Python Testing Patterns")
