#!/usr/bin/env python3
"""
Xlsx Official - DevOps Utilities

Uso:
    python xlsx_official.py --check-docker
    python xlsx_official.py --check-ci
    python xlsx_official.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Xlsx Official")
