#!/usr/bin/env python3
"""
Tdd Workflows Tdd Refactor - Testing Utilities

Uso:
    python tdd_workflows_tdd_refactor.py --file src/module.py
    python tdd_workflows_tdd_refactor.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Tdd Workflows Tdd Refactor")
