#!/usr/bin/env python3
"""
Automate Whatsapp - Utility Script

Uso:
    python automate_whatsapp.py --analyze <input>
    python automate_whatsapp.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Automate Whatsapp")
