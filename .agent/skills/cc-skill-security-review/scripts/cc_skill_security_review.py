#!/usr/bin/env python3
"""
Cc Skill Security Review - Security Scanner

Uso:
    python cc_skill_security_review.py --file src/app.py
    python cc_skill_security_review.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Cc Skill Security Review")
