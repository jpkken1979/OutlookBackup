#!/usr/bin/env python3
"""
Arm Cortex Expert - Utility Script

Uso:
    python arm_cortex_expert.py --analyze <input>
    python arm_cortex_expert.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Arm Cortex Expert")
