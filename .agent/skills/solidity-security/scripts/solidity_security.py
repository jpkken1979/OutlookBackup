#!/usr/bin/env python3
"""
Solidity Security - Security Scanner

Uso:
    python solidity_security.py --file src/app.py
    python solidity_security.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Solidity Security")
