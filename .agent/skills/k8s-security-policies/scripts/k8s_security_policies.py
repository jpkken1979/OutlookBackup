#!/usr/bin/env python3
"""
K8S Security Policies - Security Scanner

Uso:
    python k8s_security_policies.py --file src/app.py
    python k8s_security_policies.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="K8S Security Policies")
