#!/usr/bin/env python3
"""
Api Security Best Practices - Security Scanner

Uso:
    python api_security_best_practices.py --file src/app.py
    python api_security_best_practices.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Api Security Best Practices")
