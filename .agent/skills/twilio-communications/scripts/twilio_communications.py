#!/usr/bin/env python3
"""
Twilio Communications - Utility Script

Uso:
    python twilio_communications.py --analyze <input>
    python twilio_communications.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Twilio Communications")
