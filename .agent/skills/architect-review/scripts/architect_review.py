#!/usr/bin/env python3
"""
Architect Review - Utility Script

Uso:
    python architect_review.py --analyze <input>
    python architect_review.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Architect Review")
