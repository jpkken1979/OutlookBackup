#!/usr/bin/env python3
"""
Context Window Management - Utility Script

Uso:
    python context_window_management.py --analyze <input>
    python context_window_management.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Window Management")
