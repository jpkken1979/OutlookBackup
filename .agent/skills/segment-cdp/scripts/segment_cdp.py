#!/usr/bin/env python3
"""
Segment Cdp - DevOps Utilities

Uso:
    python segment_cdp.py --check-docker
    python segment_cdp.py --check-ci
    python segment_cdp.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Segment Cdp")
