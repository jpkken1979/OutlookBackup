#!/usr/bin/env python3
"""
Cloud Architect - Utility Script

Uso:
    python cloud_architect.py --analyze <input>
    python cloud_architect.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Cloud Architect")
