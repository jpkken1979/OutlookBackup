#!/usr/bin/env python3
"""
Zapier Make Patterns - Utility Script

Uso:
    python zapier_make_patterns.py --analyze <input>
    python zapier_make_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Zapier Make Patterns")
