#!/usr/bin/env python3
"""
Startup Analyst - Utility Script

Uso:
    python startup_analyst.py --analyze <input>
    python startup_analyst.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Startup Analyst")
