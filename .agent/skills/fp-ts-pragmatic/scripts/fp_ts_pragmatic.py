#!/usr/bin/env python3
"""
Fp Ts Pragmatic - Utility Script

Uso:
    python fp_ts_pragmatic.py --analyze <input>
    python fp_ts_pragmatic.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fp Ts Pragmatic")
