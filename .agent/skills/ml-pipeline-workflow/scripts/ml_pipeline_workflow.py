#!/usr/bin/env python3
"""
Ml Pipeline Workflow - DevOps Utilities

Uso:
    python ml_pipeline_workflow.py --check-docker
    python ml_pipeline_workflow.py --check-ci
    python ml_pipeline_workflow.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ml Pipeline Workflow")
