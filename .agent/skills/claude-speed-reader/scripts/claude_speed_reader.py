#!/usr/bin/env python3
"""
Claude Speed Reader - Performance Analyzer

Uso:
    python claude_speed_reader.py --file src/module.py
    python claude_speed_reader.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Claude Speed Reader")
