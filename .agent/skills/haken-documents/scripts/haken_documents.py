#!/usr/bin/env python3
"""
Haken Documents - Documentation Generator

Uso:
    python haken_documents.py --file src/module.py --output docs/
    python haken_documents.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Haken Documents")
