#!/usr/bin/env python3
"""
Microservices Patterns - Utility Script

Uso:
    python microservices_patterns.py --analyze <input>
    python microservices_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Microservices Patterns")
