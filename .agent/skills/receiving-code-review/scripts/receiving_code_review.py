#!/usr/bin/env python3
"""
Receiving Code Review - Utility Script

Uso:
    python receiving_code_review.py --analyze <input>
    python receiving_code_review.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Receiving Code Review")
