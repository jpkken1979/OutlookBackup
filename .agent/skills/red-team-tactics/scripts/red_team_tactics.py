#!/usr/bin/env python3
"""
Red Team Tactics - Utility Script

Uso:
    python red_team_tactics.py --analyze <input>
    python red_team_tactics.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Red Team Tactics")
