#!/usr/bin/env python3
"""
Upgrading Expo - Utility Script

Uso:
    python upgrading_expo.py --analyze <input>
    python upgrading_expo.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Upgrading Expo")
