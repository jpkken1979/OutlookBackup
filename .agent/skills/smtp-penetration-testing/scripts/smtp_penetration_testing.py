#!/usr/bin/env python3
"""
Smtp Penetration Testing - Testing Utilities

Uso:
    python smtp_penetration_testing.py --file src/module.py
    python smtp_penetration_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Smtp Penetration Testing")
