#!/usr/bin/env python3
"""
Bun Development - Utility Script

Uso:
    python bun_development.py --analyze <input>
    python bun_development.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Bun Development")
