...
## Relationship with `frontend-design-galaxy`

Use this skill when you already have a real product surface to analyze.

Use `frontend-design-galaxy` when you need to:

- source a public visual reference,
- compare multiple styles,
- cache normalized references locally,
- bootstrap a first-pass `DESIGN.md` or `design-system/MASTER.md`.

Use `design-md` when you need to:

- synthesize a design system from existing private assets,
- reverse-engineer a Stitch project,
- document the real current UI instead of an external inspiration.
