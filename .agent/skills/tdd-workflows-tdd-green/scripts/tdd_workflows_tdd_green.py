#!/usr/bin/env python3
"""
Tdd Workflows Tdd Green - Testing Utilities

Uso:
    python tdd_workflows_tdd_green.py --file src/module.py
    python tdd_workflows_tdd_green.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Tdd Workflows Tdd Green")
