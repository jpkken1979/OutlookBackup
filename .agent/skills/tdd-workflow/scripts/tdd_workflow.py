#!/usr/bin/env python3
"""
Tdd Workflow - Testing Utilities

Uso:
    python tdd_workflow.py --file src/module.py
    python tdd_workflow.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Tdd Workflow")
