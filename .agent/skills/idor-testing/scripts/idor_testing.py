#!/usr/bin/env python3
"""
Idor Testing - Testing Utilities

Uso:
    python idor_testing.py --file src/module.py
    python idor_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Idor Testing")
