#!/usr/bin/env python3
"""
Beautiful Prose - Utility Script

Uso:
    python beautiful_prose.py --analyze <input>
    python beautiful_prose.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Beautiful Prose")
