#!/usr/bin/env python3
"""
Aws Serverless - Utility Script

Uso:
    python aws_serverless.py --analyze <input>
    python aws_serverless.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Aws Serverless")
