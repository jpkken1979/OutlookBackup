#!/usr/bin/env python3
"""
Claude Code Guide - Frontend Analyzer

Uso:
    python claude_code_guide.py --check-a11y src/
    python claude_code_guide.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Claude Code Guide")
