#!/usr/bin/env python3
"""
Test Automator - Testing Utilities

Uso:
    python test_automator.py --file src/module.py
    python test_automator.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test Automator")
