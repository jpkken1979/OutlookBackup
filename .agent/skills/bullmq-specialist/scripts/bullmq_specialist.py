#!/usr/bin/env python3
"""
Bullmq Specialist - DevOps Utilities

Uso:
    python bullmq_specialist.py --check-docker
    python bullmq_specialist.py --check-ci
    python bullmq_specialist.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Bullmq Specialist")
