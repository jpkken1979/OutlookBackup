#!/usr/bin/env python3
"""
Security Bluebook Builder - Security Scanner

Uso:
    python security_bluebook_builder.py --file src/app.py
    python security_bluebook_builder.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Security Bluebook Builder")
