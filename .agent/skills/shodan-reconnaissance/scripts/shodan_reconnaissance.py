#!/usr/bin/env python3
"""
Shodan Reconnaissance - Utility Script

Uso:
    python shodan_reconnaissance.py --analyze <input>
    python shodan_reconnaissance.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Shodan Reconnaissance")
