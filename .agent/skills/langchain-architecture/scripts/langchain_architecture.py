#!/usr/bin/env python3
"""
Langchain Architecture - Utility Script

Uso:
    python langchain_architecture.py --analyze <input>
    python langchain_architecture.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Langchain Architecture")
