#!/usr/bin/env python3
"""
File Path Traversal - Utility Script

Uso:
    python file_path_traversal.py --analyze <input>
    python file_path_traversal.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="File Path Traversal")
