#!/usr/bin/env python3
"""
Metasploit Framework - Utility Script

Uso:
    python metasploit_framework.py --analyze <input>
    python metasploit_framework.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Metasploit Framework")
