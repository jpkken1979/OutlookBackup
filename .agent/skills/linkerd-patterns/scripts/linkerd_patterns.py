#!/usr/bin/env python3
"""
Linkerd Patterns - Utility Script

Uso:
    python linkerd_patterns.py --analyze <input>
    python linkerd_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Linkerd Patterns")
