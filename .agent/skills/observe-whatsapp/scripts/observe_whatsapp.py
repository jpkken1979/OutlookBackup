#!/usr/bin/env python3
"""
Observe Whatsapp - Utility Script

Uso:
    python observe_whatsapp.py --analyze <input>
    python observe_whatsapp.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Observe Whatsapp")
