...
> ⚠️ **Esta skill cubre SOLO el MCP server de Figma** (design-to-code).
> Para guía de diseño en Figma (componentes, variables, Auto Layout, design systems, prototipado),
> usar la skill **`figma-design`** en `.agent/skills/figma-design/SKILL.md`.
