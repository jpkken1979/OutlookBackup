#!/usr/bin/env python3
"""
Screen Reader Testing - Testing Utilities

Uso:
    python screen_reader_testing.py --file src/module.py
    python screen_reader_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Screen Reader Testing")
