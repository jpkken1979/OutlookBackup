#!/usr/bin/env python3
"""
Backend Dev Guidelines - Frontend Analyzer

Uso:
    python backend_dev_guidelines.py --check-a11y src/
    python backend_dev_guidelines.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Backend Dev Guidelines")
