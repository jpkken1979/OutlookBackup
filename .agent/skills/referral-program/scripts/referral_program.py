#!/usr/bin/env python3
"""
Referral Program - Utility Script

Uso:
    python referral_program.py --analyze <input>
    python referral_program.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Referral Program")
