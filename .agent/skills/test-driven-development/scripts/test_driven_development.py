#!/usr/bin/env python3
"""
Test Driven Development - Testing Utilities

Uso:
    python test_driven_development.py --file src/module.py
    python test_driven_development.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test Driven Development")
