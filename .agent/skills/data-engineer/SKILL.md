...
|-------|---|---|
| `data-engineering` | Complementary — pattern reference guide | Look up specific patterns (dbt, Airflow, streaming, etc.) |
| `data-engineering-data-pipeline` | Specialized — implementation patterns | Hands-on pipeline implementation |
| `data-engineering-data-driven-feature` | Specialized — ML-specific engineering | Feature engineering and ML pipelines |
