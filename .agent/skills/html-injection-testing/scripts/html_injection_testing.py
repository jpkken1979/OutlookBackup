#!/usr/bin/env python3
"""
Html Injection Testing - Testing Utilities

Uso:
    python html_injection_testing.py --file src/module.py
    python html_injection_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Html Injection Testing")
