#!/usr/bin/env python3
"""
Unreal Engine Cpp Pro - Utility Script

Uso:
    python unreal_engine_cpp_pro.py --analyze <input>
    python unreal_engine_cpp_pro.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Unreal Engine Cpp Pro")
