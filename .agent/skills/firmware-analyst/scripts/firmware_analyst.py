#!/usr/bin/env python3
"""
Firmware Analyst - Utility Script

Uso:
    python firmware_analyst.py --analyze <input>
    python firmware_analyst.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Firmware Analyst")
