#!/usr/bin/env python3
"""
Interactive Portfolio - Utility Script

Uso:
    python interactive_portfolio.py --analyze <input>
    python interactive_portfolio.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Interactive Portfolio")
