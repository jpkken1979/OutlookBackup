#!/usr/bin/env python3
"""
Software Architecture - Utility Script

Uso:
    python software_architecture.py --analyze <input>
    python software_architecture.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Software Architecture")
