#!/usr/bin/env python3
"""
Conductor New Track - Utility Script

Uso:
    python conductor_new_track.py --analyze <input>
    python conductor_new_track.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Conductor New Track")
