#!/usr/bin/env python3
"""
Aws Penetration Testing - Testing Utilities

Uso:
    python aws_penetration_testing.py --file src/module.py
    python aws_penetration_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Aws Penetration Testing")
