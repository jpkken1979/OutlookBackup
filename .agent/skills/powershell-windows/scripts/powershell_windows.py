#!/usr/bin/env python3
"""
Powershell Windows - Utility Script

Uso:
    python powershell_windows.py --analyze <input>
    python powershell_windows.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Powershell Windows")
