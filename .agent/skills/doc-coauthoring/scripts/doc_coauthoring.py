#!/usr/bin/env python3
"""
Doc Coauthoring - Security Scanner

Uso:
    python doc_coauthoring.py --file src/app.py
    python doc_coauthoring.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Doc Coauthoring")
