#!/usr/bin/env python3
"""
Top Web Vulnerabilities - Utility Script

Uso:
    python top_web_vulnerabilities.py --analyze <input>
    python top_web_vulnerabilities.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Top Web Vulnerabilities")
