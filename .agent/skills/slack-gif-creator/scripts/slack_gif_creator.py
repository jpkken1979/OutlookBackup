#!/usr/bin/env python3
"""
Slack Gif Creator - Utility Script

Uso:
    python slack_gif_creator.py --analyze <input>
    python slack_gif_creator.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Slack Gif Creator")
