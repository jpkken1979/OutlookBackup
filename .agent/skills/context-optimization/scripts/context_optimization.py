#!/usr/bin/env python3
"""
Context Optimization - Performance Analyzer

Uso:
    python context_optimization.py --file src/module.py
    python context_optimization.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Optimization")
