#!/usr/bin/env python3
"""
Upstash Qstash - Utility Script

Uso:
    python upstash_qstash.py --analyze <input>
    python upstash_qstash.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Upstash Qstash")
