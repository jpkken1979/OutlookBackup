#!/usr/bin/env python3
"""
React Best Practices - Frontend Analyzer

Uso:
    python react_best_practices.py --check-a11y src/
    python react_best_practices.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="React Best Practices")
