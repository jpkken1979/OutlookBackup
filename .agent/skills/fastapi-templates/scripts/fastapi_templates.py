#!/usr/bin/env python3
"""
Fastapi Templates - Utility Script

Uso:
    python fastapi_templates.py --analyze <input>
    python fastapi_templates.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fastapi Templates")
