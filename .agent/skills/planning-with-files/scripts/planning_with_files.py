#!/usr/bin/env python3
"""
Planning With Files - Utility Script

Uso:
    python planning_with_files.py --analyze <input>
    python planning_with_files.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Planning With Files")
