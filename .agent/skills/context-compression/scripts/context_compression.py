#!/usr/bin/env python3
"""
Context Compression - Utility Script

Uso:
    python context_compression.py --analyze <input>
    python context_compression.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Compression")
