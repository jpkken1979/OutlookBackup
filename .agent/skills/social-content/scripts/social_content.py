#!/usr/bin/env python3
"""
Social Content - DevOps Utilities

Uso:
    python social_content.py --check-docker
    python social_content.py --check-ci
    python social_content.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Social Content")
