#!/usr/bin/env python3
"""
Gdpr Data Handling - Utility Script

Uso:
    python gdpr_data_handling.py --analyze <input>
    python gdpr_data_handling.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Gdpr Data Handling")
