#!/usr/bin/env python3
"""
Context Degradation - Utility Script

Uso:
    python context_degradation.py --analyze <input>
    python context_degradation.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Degradation")
