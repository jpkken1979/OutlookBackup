#!/usr/bin/env python3
"""
Active Directory Attacks - Utility Script

Uso:
    python active_directory_attacks.py --analyze <input>
    python active_directory_attacks.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Active Directory Attacks")
