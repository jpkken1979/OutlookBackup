#!/usr/bin/env python3
"""
Reference Builder - Frontend Analyzer

Uso:
    python reference_builder.py --check-a11y src/
    python reference_builder.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Reference Builder")
