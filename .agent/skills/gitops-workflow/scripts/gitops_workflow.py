#!/usr/bin/env python3
"""
Gitops Workflow - Utility Script

Uso:
    python gitops_workflow.py --analyze <input>
    python gitops_workflow.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Gitops Workflow")
