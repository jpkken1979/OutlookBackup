#!/usr/bin/env python3
"""
Embedding Strategies - Utility Script

Uso:
    python embedding_strategies.py --analyze <input>
    python embedding_strategies.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Embedding Strategies")
