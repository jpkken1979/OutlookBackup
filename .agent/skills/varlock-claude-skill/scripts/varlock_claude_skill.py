#!/usr/bin/env python3
"""
Varlock Claude Skill - Utility Script

Uso:
    python varlock_claude_skill.py --analyze <input>
    python varlock_claude_skill.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Varlock Claude Skill")
