#!/usr/bin/env python3
"""
Sql Injection Testing - Testing Utilities

Uso:
    python sql_injection_testing.py --file src/module.py
    python sql_injection_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Sql Injection Testing")
