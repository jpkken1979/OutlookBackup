#!/usr/bin/env python3
"""
Incident Response Incident Response - DevOps Utilities

Uso:
    python incident_response_incident_response.py --check-docker
    python incident_response_incident_response.py --check-ci
    python incident_response_incident_response.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Incident Response Incident Response")
