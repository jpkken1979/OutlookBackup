#!/usr/bin/env python3
"""
Nx Workspace Patterns - Utility Script

Uso:
    python nx_workspace_patterns.py --analyze <input>
    python nx_workspace_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Nx Workspace Patterns")
