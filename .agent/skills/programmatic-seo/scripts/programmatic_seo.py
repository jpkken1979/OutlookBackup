#!/usr/bin/env python3
"""
Programmatic Seo - Utility Script

Uso:
    python programmatic_seo.py --analyze <input>
    python programmatic_seo.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Programmatic Seo")
