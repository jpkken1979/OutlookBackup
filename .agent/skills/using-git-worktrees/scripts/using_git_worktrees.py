#!/usr/bin/env python3
"""
Using Git Worktrees - Utility Script

Uso:
    python using_git_worktrees.py --analyze <input>
    python using_git_worktrees.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Using Git Worktrees")
