#!/usr/bin/env python3
"""
Terraform Specialist - DevOps Utilities

Uso:
    python terraform_specialist.py --check-docker
    python terraform_specialist.py --check-ci
    python terraform_specialist.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Terraform Specialist")
