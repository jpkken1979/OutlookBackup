#!/usr/bin/env python3
"""
Research Engineer - Utility Script

Uso:
    python research_engineer.py --analyze <input>
    python research_engineer.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Research Engineer")
