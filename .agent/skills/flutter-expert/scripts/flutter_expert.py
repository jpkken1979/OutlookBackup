#!/usr/bin/env python3
"""
Flutter Expert - Utility Script

Uso:
    python flutter_expert.py --analyze <input>
    python flutter_expert.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Flutter Expert")
