#!/usr/bin/env python3
"""
Context7 Auto Research - Utility Script

Uso:
    python context7_auto_research.py --analyze <input>
    python context7_auto_research.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context7 Auto Research")
