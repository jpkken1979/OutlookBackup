#!/usr/bin/env python3
"""
Wordpress Penetration Testing - Testing Utilities

Uso:
    python wordpress_penetration_testing.py --file src/module.py
    python wordpress_penetration_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Wordpress Penetration Testing")
