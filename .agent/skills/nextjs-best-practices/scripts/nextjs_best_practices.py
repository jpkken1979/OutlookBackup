#!/usr/bin/env python3
"""
Nextjs Best Practices - Frontend Analyzer

Uso:
    python nextjs_best_practices.py --check-a11y src/
    python nextjs_best_practices.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Nextjs Best Practices")
