#!/usr/bin/env python3
"""
Linear Claude Skill - Utility Script

Uso:
    python linear_claude_skill.py --analyze <input>
    python linear_claude_skill.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Linear Claude Skill")
