#!/usr/bin/env python3
"""
N8N Code Python - Utility Script

Uso:
    python n8n_code_python.py --analyze <input>
    python n8n_code_python.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="N8N Code Python")
