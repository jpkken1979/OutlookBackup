#!/usr/bin/env python3
"""
C4 Component - Frontend Analyzer

Uso:
    python c4_component.py --check-a11y src/
    python c4_component.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="C4 Component")
