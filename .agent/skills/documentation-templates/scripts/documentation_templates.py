...
Uso:
    python documentation_templates.py --file src/module.py --output docs/
    python documentation_templates.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Documentation Templates")
