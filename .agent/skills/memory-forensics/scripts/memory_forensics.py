#!/usr/bin/env python3
"""
Memory Forensics - Performance Analyzer

Uso:
    python memory_forensics.py --file src/module.py
    python memory_forensics.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Memory Forensics")
