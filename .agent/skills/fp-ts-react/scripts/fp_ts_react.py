#!/usr/bin/env python3
"""
Fp Ts React - Frontend Analyzer

Uso:
    python fp_ts_react.py --check-a11y src/
    python fp_ts_react.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Fp Ts React")
