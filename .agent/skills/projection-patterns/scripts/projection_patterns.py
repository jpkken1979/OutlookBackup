#!/usr/bin/env python3
"""
Projection Patterns - Utility Script

Uso:
    python projection_patterns.py --analyze <input>
    python projection_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Projection Patterns")
