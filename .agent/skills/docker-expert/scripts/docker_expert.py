#!/usr/bin/env python3
"""
Docker Expert - Documentation Generator

Uso:
    python docker_expert.py --file src/module.py --output docs/
    python docker_expert.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Docker Expert")
