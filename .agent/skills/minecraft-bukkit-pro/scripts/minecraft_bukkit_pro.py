#!/usr/bin/env python3
"""
Minecraft Bukkit Pro - Utility Script

Uso:
    python minecraft_bukkit_pro.py --analyze <input>
    python minecraft_bukkit_pro.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Minecraft Bukkit Pro")
