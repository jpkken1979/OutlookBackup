#!/usr/bin/env python3
"""
Code Documentation Doc Generate - Documentation Generator

Uso:
    python code_documentation_doc_generate.py --file src/module.py --output docs/
    python code_documentation_doc_generate.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Code Documentation Doc Generate")
