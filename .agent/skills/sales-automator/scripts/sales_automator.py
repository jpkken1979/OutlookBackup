#!/usr/bin/env python3
"""
Sales Automator - Utility Script

Uso:
    python sales_automator.py --analyze <input>
    python sales_automator.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Sales Automator")
