#!/usr/bin/env python3
"""
Openapi Spec Generation - Utility Script

Uso:
    python openapi_spec_generation.py --analyze <input>
    python openapi_spec_generation.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Openapi Spec Generation")
