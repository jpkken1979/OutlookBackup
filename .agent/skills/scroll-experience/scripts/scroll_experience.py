#!/usr/bin/env python3
"""
Scroll Experience - Utility Script

Uso:
    python scroll_experience.py --analyze <input>
    python scroll_experience.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Scroll Experience")
