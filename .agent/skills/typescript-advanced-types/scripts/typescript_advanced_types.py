#!/usr/bin/env python3
"""
Typescript Advanced Types - Utility Script

Uso:
    python typescript_advanced_types.py --analyze <input>
    python typescript_advanced_types.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Typescript Advanced Types")
