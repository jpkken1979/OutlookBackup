#!/usr/bin/env python3
"""
Ffuf Claude Skill - Utility Script

Uso:
    python ffuf_claude_skill.py --analyze <input>
    python ffuf_claude_skill.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ffuf Claude Skill")
