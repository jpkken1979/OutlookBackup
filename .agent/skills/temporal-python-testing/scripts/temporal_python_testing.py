#!/usr/bin/env python3
"""
Temporal Python Testing - Testing Utilities

Uso:
    python temporal_python_testing.py --file src/module.py
    python temporal_python_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Temporal Python Testing")
