#!/usr/bin/env python3
"""
Error Debugging Error Trace - Utility Script

Uso:
    python error_debugging_error_trace.py --analyze <input>
    python error_debugging_error_trace.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Error Debugging Error Trace")
