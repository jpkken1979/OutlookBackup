#!/usr/bin/env python3
"""
Bats Testing Patterns - Testing Utilities

Uso:
    python bats_testing_patterns.py --file src/module.py
    python bats_testing_patterns.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Bats Testing Patterns")
