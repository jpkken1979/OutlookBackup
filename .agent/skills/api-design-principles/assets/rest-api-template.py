...
app.add_middleware(
    ...
    allowed_hosts=["*"],  # Producción: configurar hosts específicos, ej. ["api.example.com"]
)

# CORS: Configures Cross-Origin Resource Sharing
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Producción: actualizar con orígenes específicos
    allow_credentials=False,  # Producción: True si necesitas cookies/auth, pero restringir orígenes
    allow_methods=["*"],
    allow_headers=["*"],
)
