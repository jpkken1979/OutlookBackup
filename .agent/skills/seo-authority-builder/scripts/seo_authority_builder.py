#!/usr/bin/env python3
"""
Seo Authority Builder - Security Scanner

Uso:
    python seo_authority_builder.py --file src/app.py
    python seo_authority_builder.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Seo Authority Builder")
