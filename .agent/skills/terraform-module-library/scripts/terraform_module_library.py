#!/usr/bin/env python3
"""
Terraform Module Library - DevOps Utilities

Uso:
    python terraform_module_library.py --check-docker
    python terraform_module_library.py --check-ci
    python terraform_module_library.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Terraform Module Library")
