#!/usr/bin/env python3
"""
Systematic Debugging - Utility Script

Uso:
    python systematic_debugging.py --analyze <input>
    python systematic_debugging.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Systematic Debugging")
