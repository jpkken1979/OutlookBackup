#!/usr/bin/env python3
"""
Nextjs Supabase Auth - Security Scanner

Uso:
    python nextjs_supabase_auth.py --file src/app.py
    python nextjs_supabase_auth.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Nextjs Supabase Auth")
