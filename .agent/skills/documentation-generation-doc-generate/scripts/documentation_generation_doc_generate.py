#!/usr/bin/env python3
"""
Documentation Generation Doc Generate - Documentation Generator

Uso:
    python documentation_generation_doc_generate.py --file src/module.py --output docs/
    python documentation_generation_doc_generate.py --dir src/ --format markdown
"""
...
def main():
    parser = argparse.ArgumentParser(description="Documentation Generation Doc Generate")
