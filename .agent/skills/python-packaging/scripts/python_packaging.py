#!/usr/bin/env python3
"""
Python Packaging - Utility Script

Uso:
    python python_packaging.py --analyze <input>
    python python_packaging.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Python Packaging")
