#!/usr/bin/env python3
"""
Clerk Auth - Security Scanner

Uso:
    python clerk_auth.py --file src/app.py
    python clerk_auth.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Clerk Auth")
