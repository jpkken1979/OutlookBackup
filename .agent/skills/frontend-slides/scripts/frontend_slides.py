#!/usr/bin/env python3
"""
Frontend Slides - Frontend Analyzer

Uso:
    python frontend_slides.py --check-a11y src/
    python frontend_slides.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Frontend Slides")
