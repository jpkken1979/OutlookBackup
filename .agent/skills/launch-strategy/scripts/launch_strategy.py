#!/usr/bin/env python3
"""
Launch Strategy - Utility Script

Uso:
    python launch_strategy.py --analyze <input>
    python launch_strategy.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Launch Strategy")
