#!/usr/bin/env python3
"""
Ui Ux Designer - Frontend Analyzer

Uso:
    python ui_ux_designer.py --check-a11y src/
    python ui_ux_designer.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ui Ux Designer")
