#!/usr/bin/env python3
"""
Broken Authentication - Security Scanner

Uso:
    python broken_authentication.py --file src/app.py
    python broken_authentication.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Broken Authentication")
