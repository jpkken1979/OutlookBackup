#!/usr/bin/env python3
"""
Unity Ecs Patterns - Testing Utilities

Uso:
    python unity_ecs_patterns.py --file src/module.py
    python unity_ecs_patterns.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Unity Ecs Patterns")
