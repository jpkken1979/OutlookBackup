#!/usr/bin/env python3
"""
Api Fuzzing Bug Bounty - Utility Script

Uso:
    python api_fuzzing_bug_bounty.py --analyze <input>
    python api_fuzzing_bug_bounty.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Api Fuzzing Bug Bounty")
