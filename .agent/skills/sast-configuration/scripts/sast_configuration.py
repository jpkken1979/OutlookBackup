#!/usr/bin/env python3
"""
Sast Configuration - Utility Script

Uso:
    python sast_configuration.py --analyze <input>
    python sast_configuration.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Sast Configuration")
