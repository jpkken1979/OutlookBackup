#!/usr/bin/env python3
"""
Cc Skill Project Guidelines Example - Frontend Analyzer

Uso:
    python cc_skill_project_guidelines_example.py --check-a11y src/
    python cc_skill_project_guidelines_example.py --check-perf public/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Cc Skill Project Guidelines Example")
