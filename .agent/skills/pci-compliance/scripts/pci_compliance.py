#!/usr/bin/env python3
"""
Pci Compliance - DevOps Utilities

Uso:
    python pci_compliance.py --check-docker
    python pci_compliance.py --check-ci
    python pci_compliance.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Pci Compliance")
