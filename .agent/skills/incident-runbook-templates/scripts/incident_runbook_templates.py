#!/usr/bin/env python3
"""
Incident Runbook Templates - DevOps Utilities

Uso:
    python incident_runbook_templates.py --check-docker
    python incident_runbook_templates.py --check-ci
    python incident_runbook_templates.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Incident Runbook Templates")
