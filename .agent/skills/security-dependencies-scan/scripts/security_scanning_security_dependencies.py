#!/usr/bin/env python3
"""
Security Scanning Security Dependencies - Security Scanner

Uso:
    python security_scanning_security_dependencies.py --file src/app.py
    python security_scanning_security_dependencies.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Security Scanning Security Dependencies")
