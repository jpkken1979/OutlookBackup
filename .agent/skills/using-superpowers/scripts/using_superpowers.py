#!/usr/bin/env python3
"""
Using Superpowers - Utility Script

Uso:
    python using_superpowers.py --analyze <input>
    python using_superpowers.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Using Superpowers")
