#!/usr/bin/env python3
"""
Avalonia Layout Zafiro - Utility Script

Uso:
    python avalonia_layout_zafiro.py --analyze <input>
    python avalonia_layout_zafiro.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Avalonia Layout Zafiro")
