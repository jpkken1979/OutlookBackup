#!/usr/bin/env python3
"""
Nodejs Best Practices - Utility Script

Uso:
    python nodejs_best_practices.py --analyze <input>
    python nodejs_best_practices.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Nodejs Best Practices")
