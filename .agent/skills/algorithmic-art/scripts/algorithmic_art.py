#!/usr/bin/env python3
"""
Algorithmic Art - Utility Script

Uso:
    python algorithmic_art.py --analyze <input>
    python algorithmic_art.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Algorithmic Art")
