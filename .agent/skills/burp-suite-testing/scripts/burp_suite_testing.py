#!/usr/bin/env python3
"""
Burp Suite Testing - Testing Utilities

Uso:
    python burp_suite_testing.py --file src/module.py
    python burp_suite_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Burp Suite Testing")
