#!/usr/bin/env python3
"""
Dotnet Architect - Utility Script

Uso:
    python dotnet_architect.py --analyze <input>
    python dotnet_architect.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Dotnet Architect")
