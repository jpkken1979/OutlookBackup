#!/usr/bin/env python3
"""
Startup Financial Modeling - DevOps Utilities

Uso:
    python startup_financial_modeling.py --check-docker
    python startup_financial_modeling.py --check-ci
    python startup_financial_modeling.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Startup Financial Modeling")
