#!/usr/bin/env python3
"""
Workflow Patterns - Utility Script

Uso:
    python workflow_patterns.py --analyze <input>
    python workflow_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Workflow Patterns")
