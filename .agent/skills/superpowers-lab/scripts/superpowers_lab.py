#!/usr/bin/env python3
"""
Superpowers Lab - Utility Script

Uso:
    python superpowers_lab.py --analyze <input>
    python superpowers_lab.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Superpowers Lab")
