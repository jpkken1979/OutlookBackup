#!/usr/bin/env python3
"""
Security Requirement Extraction - Security Scanner

Uso:
    python security_requirement_extraction.py --file src/app.py
    python security_requirement_extraction.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Security Requirement Extraction")
