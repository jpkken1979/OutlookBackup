#!/usr/bin/env python3
"""
Conductor Revert - Utility Script

Uso:
    python conductor_revert.py --analyze <input>
    python conductor_revert.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Conductor Revert")
