#!/usr/bin/env python3
"""
Nosql Expert - Database Utilities

Uso:
    python nosql_expert.py --analyze schema.sql
    python nosql_expert.py --check-models models.py
"""
...
def main():
    parser = argparse.ArgumentParser(description="Nosql Expert")
