#!/usr/bin/env python3
"""
Architecture Decision Records - DevOps Utilities

Uso:
    python architecture_decision_records.py --check-docker
    python architecture_decision_records.py --check-ci
    python architecture_decision_records.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Architecture Decision Records")
