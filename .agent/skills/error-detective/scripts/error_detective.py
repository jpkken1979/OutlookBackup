#!/usr/bin/env python3
"""
Error Detective - Utility Script

Uso:
    python error_detective.py --analyze <input>
    python error_detective.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Error Detective")
