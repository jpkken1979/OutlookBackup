#!/usr/bin/env python3
"""
Algolia Search - Utility Script

Uso:
    python algolia_search.py --analyze <input>
    python algolia_search.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Algolia Search")
