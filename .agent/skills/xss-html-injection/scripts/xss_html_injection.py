#!/usr/bin/env python3
"""
Xss Html Injection - Security Scanner

Uso:
    python xss_html_injection.py --file src/app.py
    python xss_html_injection.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Xss Html Injection")
