#!/usr/bin/env python3
"""
Expo Deployment - DevOps Utilities

Uso:
    python expo_deployment.py --check-docker
    python expo_deployment.py --check-ci
    python expo_deployment.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Expo Deployment")
