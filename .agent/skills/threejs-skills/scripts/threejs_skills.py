#!/usr/bin/env python3
"""
Threejs Skills - Utility Script

Uso:
    python threejs_skills.py --analyze <input>
    python threejs_skills.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Threejs Skills")
