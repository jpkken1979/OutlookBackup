#!/usr/bin/env python3
"""
Typescript Pro - Utility Script

Uso:
    python typescript_pro.py --analyze <input>
    python typescript_pro.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Typescript Pro")
