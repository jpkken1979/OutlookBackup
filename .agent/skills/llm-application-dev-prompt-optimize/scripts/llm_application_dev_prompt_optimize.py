#!/usr/bin/env python3
"""
Llm Application Dev Prompt Optimize - Performance Analyzer

Uso:
    python llm_application_dev_prompt_optimize.py --file src/module.py
    python llm_application_dev_prompt_optimize.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Llm Application Dev Prompt Optimize")
