#!/usr/bin/env python3
"""
Context Driven Development - Utility Script

Uso:
    python context_driven_development.py --analyze <input>
    python context_driven_development.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Context Driven Development")
