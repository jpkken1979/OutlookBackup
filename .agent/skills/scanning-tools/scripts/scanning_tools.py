#!/usr/bin/env python3
"""
Scanning Tools - Utility Script

Uso:
    python scanning_tools.py --analyze <input>
    python scanning_tools.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Scanning Tools")
