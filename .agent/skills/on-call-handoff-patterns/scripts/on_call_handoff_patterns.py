#!/usr/bin/env python3
"""
On Call Handoff Patterns - Utility Script

Uso:
    python on_call_handoff_patterns.py --analyze <input>
    python on_call_handoff_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="On Call Handoff Patterns")
