#!/usr/bin/env python3
"""
Incident Responder - DevOps Utilities

Uso:
    python incident_responder.py --check-docker
    python incident_responder.py --check-ci
    python incident_responder.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Incident Responder")
