#!/usr/bin/env python3
"""
Event Store Design - Utility Script

Uso:
    python event_store_design.py --analyze <input>
    python event_store_design.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Event Store Design")
