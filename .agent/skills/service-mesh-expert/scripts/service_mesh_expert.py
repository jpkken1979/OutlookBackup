#!/usr/bin/env python3
"""
Service Mesh Expert - Utility Script

Uso:
    python service_mesh_expert.py --analyze <input>
    python service_mesh_expert.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Service Mesh Expert")
