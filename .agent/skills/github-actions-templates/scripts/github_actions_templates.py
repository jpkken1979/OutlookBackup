#!/usr/bin/env python3
"""
Github Actions Templates - DevOps Utilities

Uso:
    python github_actions_templates.py --check-docker
    python github_actions_templates.py --check-ci
    python github_actions_templates.py --all
"""
...
def main():
    parser = argparse.ArgumentParser(description="Github Actions Templates")
