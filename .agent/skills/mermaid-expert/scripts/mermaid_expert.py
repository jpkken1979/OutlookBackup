#!/usr/bin/env python3
"""
Mermaid Expert - Utility Script

Uso:
    python mermaid_expert.py --analyze <input>
    python mermaid_expert.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Mermaid Expert")
