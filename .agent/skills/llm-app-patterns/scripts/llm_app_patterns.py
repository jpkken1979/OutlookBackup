#!/usr/bin/env python3
"""
Llm App Patterns - Utility Script

Uso:
    python llm_app_patterns.py --analyze <input>
    python llm_app_patterns.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Llm App Patterns")
