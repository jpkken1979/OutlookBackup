#!/usr/bin/env python3
"""
Ssh Penetration Testing - Testing Utilities

Uso:
    python ssh_penetration_testing.py --file src/module.py
    python ssh_penetration_testing.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ssh Penetration Testing")
