#!/usr/bin/env python3
"""
Cc Skill Clickhouse Io - Utility Script

Uso:
    python cc_skill_clickhouse_io.py --analyze <input>
    python cc_skill_clickhouse_io.py --help
"""
...
def main():
    parser = argparse.ArgumentParser(description="Cc Skill Clickhouse Io")
