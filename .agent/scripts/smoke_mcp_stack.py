...
def check_tauri_hooks(repo_root: Path) -> CheckResult:
    """Verifica que Tauri expone hooks Memory/Teams."""
    ...
    required = [
        ...
        "pub async fn execute_agent_teams_pipeline",
        "commands::ecosystem::check_memory_status",
        "commands::ecosystem::execute_agent_teams_pipeline",
    ]
    ...
    return CheckResult(
        name="tauri-hooks",
        ok=True,
        details="Hooks Tauri Memory/Teams detectados",
        critical=True,
    )
