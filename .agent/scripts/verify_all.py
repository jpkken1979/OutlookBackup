...
Examples:
  ...
  python scripts/verify_all.py . --url https://staging.example.com --no-e2e
    ...
    parser.add_argument("--url", required=False, help="URL for performance & E2E checks (optional)")
    ...
    print(
        f"URL: {args.url if args.url else 'Not provided (performance/E2E checks will be skipped)'}"
    )
