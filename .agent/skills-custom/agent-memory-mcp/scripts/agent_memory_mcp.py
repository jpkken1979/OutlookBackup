#!/usr/bin/env python3
"""
Agent Memory Mcp - Performance Analyzer

Uso:
    python agent_memory_mcp.py --file src/module.py
    python agent_memory_mcp.py --dir src/ --output report.json
"""
...
def main():
    parser = argparse.ArgumentParser(description="Agent Memory Mcp")
