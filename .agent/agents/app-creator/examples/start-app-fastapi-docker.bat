...
REM ============================================================================
REM App Creator - FastAPI Docker Launcher
REM Descripción: Script para iniciar aplicación FastAPI en Docker
REM Características: build automático, puerto dinámico, volúmenes para desarrollo
REM ============================================================================

title FastAPI Application - Docker Launcher
color 0B
...
set "CONTAINER_NAME=fastapi-app-dev"
set "IMAGE_NAME=fastapi-app:dev"
...
if not exist "Dockerfile" (
    ...
    (
        ...
        echo     CMD curl -f http://localhost:8000/docs ^|^| exit 1
        echo.
        echo EXPOSE 8000
        echo CMD ["python", "-m", "uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000"]
    ) > Dockerfile
...
echo %YELLOW% Puerto Container: 8000
