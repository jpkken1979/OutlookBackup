...
class AutoUpdater:
    ...
    def apply_update(self, force: bool = False) -> UpdateResult:
        ...
        try:
            ...
            logger.info("Update applied successfully: %s -> %s", info.current_version, new_version)
            return UpdateResult(
                success=True,
            ...
            logger.error("Update failed, rolling back: %s", e)
...
def _cmd_check(updater: "AutoUpdater", args) -> None:
    ...
    Args:
        updater: Instancia del auto-updater.
        args: Namespace de argparse con las opciones del CLI.
    """
...
def main():
    ...
    handlers[args.command](updater, args)
