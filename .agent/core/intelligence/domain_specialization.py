...
class DomainSpecializer:
    ...
    def __init__(self, memory_dir: Path | None = None):
        ...
        elif os.environ.get("ANTIGRAVITY_SPECIALIZATION_PATH"):
            self.memory_dir = Path(os.environ["ANTIGRAVITY_SPECIALIZATION_PATH"])
        else:
            self.memory_dir = Path.home() / ".antigravity" / "memory" / "specialization"
