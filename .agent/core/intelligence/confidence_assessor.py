#!/usr/bin/env python3
"""
ConfidenceAssessor Module - Knowing what you know and don't know.
...
Usage:
    from .agent.core.intelligence import ConfidenceAssessor

    meta = ConfidenceAssessor()
...
logger = logging.getLogger("antigravity.intelligence.confidence_assessor")
...
class ConfidenceAssessor:
    """
    ConfidenceAssessor engine - self-aware reasoning about knowledge and abilities.
    ...
    def __init__(
        ...
        elif os.environ.get("ANTIGRAVITY_METACOGNITION_PATH"):
            self.memory_dir = Path(os.environ["ANTIGRAVITY_METACOGNITION_PATH"])
        else:
            self.memory_dir = Path.home() / ".antigravity" / "memory" / "metacognition"
        ...
        logger.info("ConfidenceAssessor engine initialized")
