...
class ChainOfThoughtResult:
    ...
    def to_markdown(self) -> str:
        ...
        for step in self.steps:
            lines.append(f"### Step {step.step_num}: {step.thought_type.value.upper()}")
            lines.append("")
            ...
            if step.alternatives_considered:
                ...
                for a in step.alternatives_considered:
                    lines.append(f"- {a}")

            if step.risks_identified:
                lines.append("")
                lines.append("**Risks:**")
                for r in step.risks_identified:
                    lines.append(f"- {r}")
...
class ChainOfThought:
    ...
    def __init__(
        ...
        self.memory_dir = memory_dir or Path(".agent/memory/thoughts")
