...
- ConfidenceAssessor: Knowing what you don't know
...
from .confidence_assessor import ConfidenceAssessment, ConfidenceAssessor, assess_confidence
...
# Metacognition vive en core/metacognition.py (fuera del paquete); se re-exporta
# aca para que intelligence_layer lo resuelva junto a las demas capabilities.
try:
    from ..metacognition import Metacognition as _Metacognition
except ImportError:  # Soporta cargar ``intelligence`` con ``.agent/core`` en sys.path.
    from metacognition import Metacognition as _Metacognition  # type: ignore[no-redef]
...
__all__ = [
    ...
    "DebateResult",
    "quick_debate",
    # Metacognition (re-exportada desde core.metacognition)
    "Metacognition",
    # ConfidenceAssessor
    "ConfidenceAssessor",
