...
class QualityScorer:
    ...
    def __init__(
        ...
        elif os.environ.get("ANTIGRAVITY_QUALITY_PATH"):
            self.memory_dir = Path(os.environ["ANTIGRAVITY_QUALITY_PATH"])
        else:
            self.memory_dir = Path.home() / ".antigravity" / "memory" / "quality"
