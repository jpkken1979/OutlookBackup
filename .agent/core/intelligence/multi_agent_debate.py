...
class MultiAgentDebate:
    ...
    def __init__(
        ...
        elif os.environ.get("ANTIGRAVITY_DEBATES_PATH"):
            self.memory_dir = Path(os.environ["ANTIGRAVITY_DEBATES_PATH"])
        else:
            self.memory_dir = Path.home() / ".antigravity" / "memory" / "debates"
