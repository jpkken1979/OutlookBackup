...
def _discover_agents(
    ...
    for agent_dir in sorted(agents_dir.iterdir()):
        result = _discover_single_agent(agent_dir, agent_config_class, deprecated_agent_names)
...
def _discover_single_agent(
    ...
    Args:
        ...
        agent_config_class: Clase AgentConfig (o None para import tardío).
        deprecated: Nombres de agentes deprecados a ignorar.

    Returns:
        Tupla (nombre, config) si es un agente válido, o None si se omite/falla.
    """
    ...
    try:
        ...
        return agent_dir.name, _resolve_agent_metadata(
