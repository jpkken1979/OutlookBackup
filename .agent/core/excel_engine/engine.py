...
class ExcelEngine:
    ...
    def create_chart(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.create_chart(
                h, sheet=sheet, range_addr=range_addr,
    ...
    def create_pivot(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.create_pivot(
                h, sheet=sheet, data_range=data_range, dest_cell=dest_cell,
    ...
    def update_dashboard(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.update_dashboard(
                h, dashboard_sheet=dashboard_sheet,
    ...
    def power_query(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.power_query(
                h, query_name=query_name, connection_string=connection_string,
    ...
    def dax_measure(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.dax_measure(
                h, table_name=table_name, measure_name=measure_name,
    ...
    def slicer(
        ...
        def _do(h: Any) -> dict[str, Any]:
            return self._xlwings.slicer(
                h, pivot_table_name=pivot_table_name, source_field=source_field,
    ...
    def conditional_format(
        ...
        range_addr: str,
        rule_type: Literal[
            "cell_value", "formula", "color_scale", "data_bar", "icon_set"
        ],
