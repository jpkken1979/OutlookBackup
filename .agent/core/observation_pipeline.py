...
class ObservationPipeline:
    ...
    def _feed_subsystems(self, obs: Observation) -> None:
        ...
        # 1. IntelligenceHub - solo para acciones significativas
        ...
        # 2. LearningLoop - registrar accion
        if obs.priority in ("critical", "high", "medium"):
        ...
        # 3. ProjectMemory - registrar hotspot de archivos
        pm = self._get_project_memory()
        if pm and obs.files_affected:
            try:
