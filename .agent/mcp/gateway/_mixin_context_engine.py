...
class _ContextEngineMixin:
    ...
    async def handle_context_engine_list(self, request: web.Request) -> web.Response:
    ...
    async def handle_context_engine_current(self, request: web.Request) -> web.Response:
    ...
    async def handle_context_engine_switch(self, request: web.Request) -> web.Response:
        ...
        return web.json_response({"ok": True, "name": name, "config_path": str(config_path)})

    async def handle_context_engine_preview(self, request: web.Request) -> web.Response:
    ...
    async def handle_context_engine_stats(self, request: web.Request) -> web.Response:
