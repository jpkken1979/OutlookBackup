...
def _build_config() -> WatcherConfig:
    ...
    return WatcherConfig(
        ...
        gateway_url=os.environ.get("ANTIGRAVITY_GATEWAY_URL", "http://127.0.0.1:4747").strip()
...
TOOL_DESCRIPTIONS: dict[str, str] = {
    ...
    "watch_matches": (
        "Matches persistidos en SQLite para un watch, ordenados de mas reciente a mas viejo."
    ),
    "watch_kill": (
    ...
    "watch_list": (
        "Lista watches activos en memoria + hasta 50 watches finalizados recientes del store."
    ),
