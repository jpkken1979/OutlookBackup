...
- [Sesion 2026-05-13 jp haz-todo](session_2026-05-13.md) — **9 commits, 5/6 fases del plan v3.2 cerradas + Feature C backend.** 87 → 171 tests (+84). Modulos nuevos: runtime_check, path_utils, outlook/version, date_filter. Refactor de 8 modulos. Pendiente para v3.2.0: Features A/B (incremental, indexed), UI de C, VSS, smoke manual.
